...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles && !data.hasCSS) {
          data.hasCSS = !!addStyleSheet(ownerDocument,
            ...
            'annonce,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}' +
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr annonce aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video',
