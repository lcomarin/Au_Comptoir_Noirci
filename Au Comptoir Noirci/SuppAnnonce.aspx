<%@ Page Title="Suppression d'annonce" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuppAnnonce.aspx.cs" Inherits="Au_Comptoir_Noirci.SuppAnnonce" %>

<asp:Content ID='BodyContent' ContentPlaceHolderID='MainContent' runat='server'>
    <div class='container'>
        <div class='col-md-9 panelwood'>
            <h2 id='titre_annonce' runat='server'> Suppression de l'annonce </h2>
